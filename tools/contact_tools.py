...
async def check_discrepancy_1(provided, pan, aadhar, tax, field_name):
    mismatched_fields = []
...
async def check_discrepancy_address(provided_address, pan, aadhar, government, field_name):
    ...
    pan_match = fuzz.ratio(provided_address, pan) >= 60
    aadhar_match = fuzz.ratio(provided_address, aadhar) >= 60
    government_match = fuzz.ratio(provided_address, government) >= 60
